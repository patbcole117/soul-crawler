...
export const DUNGEONS = [
  { name: 'Shattered Chapel', flavor: 'A parish where the bells still ring for no one.', biome: 'stone',
  ...
  { name: 'Weeping Catacombs', flavor: 'Tears of the dead seep through limestone that remembers every name.', biome: 'bone',
    enemies: ['Crypt Rat', 'Wailing Shade', 'Ossuary Crawler', 'Tomb Jackal'],
    boss: { name: 'Mother Ilenna', title: 'Keeper of Salt Tears' } },
  { name: 'Grave Orchard', flavor: 'Apple trees grown fat on centuries of buried grief.', biome: 'orchard',
  ...
  { name: 'Cinderwood Hollow', flavor: 'A forest that burned a thousand years ago and never stopped.', biome: 'ash',
    enemies: ['Cinder Stag', 'Smoldering Treant', 'Ashbark Wolf', 'Kindling Wisp'],
    boss: { name: 'Old Emberhorn', title: 'Lord of the Cinderwood' } },
  { name: 'The Blackened Spire', flavor: "A tower that fell upward, into a sky that isn't there.", biome: 'void',
    enemies: ['Spire Gargoyle', 'Voidling Bat', 'Warped Sentinel', 'Falling Choir'],
    boss: { name: 'Architect Vhalor', title: 'Mason of the Wrong Sky' } },
  { name: "Purgatory's Threshold", flavor: 'Neither dead nor forgiven, they wait here forever.', biome: 'void',
  ...
  { name: 'The Screaming Vault', flavor: "A treasury of stolen voices, and none of them are quiet.", biome: 'void',
    enemies: ['Shrieking Coffer', 'Voice-Eater', 'Vault Wisp', 'Iron Mute'],
    boss: { name: 'Chancellor Grael', title: 'Hoarder of Screams' } },
  { name: 'Cathedral of Broken Wings', flavor: 'Feathers of a thousand fallen angels carpet the nave.', biome: 'stone',
  ...
  { name: 'The Obsidian Choir', flavor: 'Statues sing hymns carved from volcanic glass.', biome: 'void',
    enemies: ['Glass Chorister', 'Obsidian Deacon', 'Shard Wisp', 'Black Hymnal'],
    boss: { name: 'Cantor Ixthara', title: 'Voice of the Black Hymn' } },
  { name: 'Wraithmarch Tunnels', flavor: 'An army of the dead still marches to a war that ended centuries ago.', biome: 'bone',
  ...
  { name: 'The Sable Reliquary', flavor: 'A vault of black gold guarded by things that used to be holy.', biome: 'legion',
  ...
  { name: 'Furnace of the Forsworn', flavor: 'Oathbreakers burn here, and their oaths burn with them.', biome: 'molten',
    enemies: ['Forsworn Knight', 'Furnace Imp', 'Broken-Oath Wraith', 'Slag Hound'],
    boss: { name: 'Sir Kaelmourne', title: 'The Oathless Blade' } },
  { name: 'The Molten Chancel', flavor: 'A church where the altar never cools.', biome: 'molten',
    enemies: ['Chancel Salamander', 'Molten Deacon', 'Slag Cherub', 'Cinderglass Wraith'],
    boss: { name: 'Bishop Ythrane', title: 'The Burning Vow' } },
  { name: 'Abyssal Garrison', flavor: 'Hell keeps a standing army, and this is its barracks.', biome: 'legion',
    enemies: ['Abyssal Legionnaire', 'Pit Sergeant', 'Hellhound Pup', 'Garrison Brute'],
    boss: { name: 'Captain Morvax', title: 'Fist of the Legion' } },
  { name: 'The Charred Sanctum', flavor: 'Even the shadows are burned into the walls here.', biome: 'ash',
  ...
  { name: "Legion's Hollow", flavor: 'Ten thousand devils once camped here, and never quite left.', biome: 'legion',
    enemies: ['Hollow Grunt', 'Legion Skirmisher', 'Pit Drummer', 'Warcaller Imp'],
    boss: { name: 'Warlord Bhaskrul', title: 'Voice of Ten Thousand' } },
  { name: 'The Bleeding Gate', flavor: 'A door that has been dying to open for an age.', biome: 'legion',
  ...
  { name: 'Throneroom of Ash', flavor: 'A king rules over a kingdom of embers and regret.', biome: 'ash',
    enemies: ['Ash Courtier', 'Ember Herald', 'Throneguard Wraith', 'Cinder Chancellor'],
    boss: { name: 'King Ashrend', title: 'The Cindered Crown' } },
  { name: 'The Ember Dominion', flavor: "The devils' true holdings begin here, and the air itself resents you.", biome: 'molten',
  ...
  { name: 'Wrathspire Citadel', flavor: 'A fortress built from the anger of every soul it has ever taken.', biome: 'legion',
  ...
  { name: 'The Last Cathedral', flavor: 'The final holy ground, and it has already lost.', biome: 'stone',
    enemies: ['Fallen Cardinal', 'Cathedral Revenant', 'Last Choir', 'Bell of Ruin'],
    boss: { name: 'Cardinal Seraphine', title: 'The Last Confession' } },
  { name: "The Devil's Antechamber", flavor: 'One door remains between the world and the thing that wants it.', biome: 'legion',
